...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File your_file_name = new File("C:\\Users\\DenG14\\Desktop\\For_Tests\\ForOutput.txt");

            OutputStream outputStream = new FileOutputStream(your_file_name, false);
            InputStream inputStream = new FileInputStream(your_file_name);

            Human ivanov = new Human("Ivanov", new Asset("home"), new Asset("car"), new Asset("phone"), new Asset("computer"));
            ...
            System.out.println(ivanov.assets.get(3).getName());
