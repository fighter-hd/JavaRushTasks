...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File your_file_name = File.createTempFile("C:\\Users\\DenG14\\Desktop\\For_Tests\\ForOutput.txt", null);
    ...
    public static class Human {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            PrintStream writer = new PrintStream(new BufferedOutputStream(outputStream));
            writer.println(name);
